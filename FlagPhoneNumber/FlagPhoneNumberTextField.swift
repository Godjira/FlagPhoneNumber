...
open class FPNTextField: UITextField, FPNCountryPickerDelegate, FPNDelegate {
    ...
    open lazy var countryPicker: FPNCountryPicker = FPNCountryPicker()
    private lazy var phoneUtil: NBPhoneNumberUtil = NBPhoneNumberUtil()
    private var nbPhoneNumber: NBPhoneNumber?
    open var formatter: NBAsYouTypeFormatter?
    public var endEditingTextField = UITextField()
    ...
    @objc func displayCountryKeyboard() {
    ...
    @objc private func resetKeyBoard(textField: UITextField) {
        endEditingTextField.endEditing(true)
    }
    ...
    public func getToolBar(with items: [UIBarButtonItem]) -> UIToolbar {
    ...
    open func getCountryListBarButtonItems() -> [UIBarButtonItem] {
